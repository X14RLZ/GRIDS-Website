...
-- 10. CBMS REPORTS
-- Dedicated storage for official CBMS Data Reports
CREATE TABLE cbms_reports (
    id SERIAL PRIMARY KEY,
    title VARCHAR(255) NOT NULL,
    section CHAR(1) NOT NULL, -- 'E', 'L', 'P', etc.
...
CREATE INDEX idx_cbms_reports_section ON cbms_reports(section);
