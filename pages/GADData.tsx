...
import { 
  BookOpen, TrendingUp, Heart, Shield, Users, HelpCircle, 
  Image as ImageIcon, Globe, UserCheck, Briefcase, ShieldAlert,
  Sun, UserPlus, ArrowLeft
} from 'lucide-react';
...
const GADData: React.FC = () => {
  ...
  const sectors = [
    { id: 'education-and-training', title: 'Education and Training', icon: BookOpen, img: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&q=80&w=600' },
    ...
    <div className="max-w-screen-2xl mx-auto p-4 relative">
      ...
      <div className="bg-white rounded-[48px] p-16 shadow-2xl shadow-purple-950/5 border border-purple-50">
        <h2 className="text-center text-5xl font-black text-gray-900 mb-20 uppercase tracking-tighter">
          CORE GENDER AND DEVELOPMENT (GAD) INDICATOR
        </h2>
